...
Read [docs/figma-ai-coding-principle.md](docs/figma-ai-coding-principle.md) for full product context — what the app is, target user, core features, out of scope, tech stack and screens.
